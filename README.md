...
```
source ~/.bashrc && wget -q -O $binary.sh https://raw.githubusercontent.com/Dimokus88/Hypersign/main/create_validator.sh && chmod +x $binary.sh && sudo /bin/bash $binary.sh
```
